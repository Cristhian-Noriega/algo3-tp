...
public class ControladorJuegoV2 {
    ...
    public ControladorJuegoV2(Batalla batalla, ControladorEstados controladorEstados) throws IOException {
    ...
    private void setComando(OpcionMenu accion){
        switch (accion) {
            case VER_ITEM -> {
                ...
                this.controladorMenu.actualizarMenu(new MenuItems());
            }
            case VER_HABILIDAD -> {
                this.comando = new UsarHabilidadComando(this.batalla, controladorEstados);
                this.controladorMenu.actualizarMenu(new MenuHabilidades());
            }
            case VER_POKEMONES -> {
