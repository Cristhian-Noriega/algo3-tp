...
public abstract class Habilidad2 {
    ...
    public void setAmbiente(AdministradorDeClima administradorDeClima, Clima climaActual, List<Pokemon> pokemonesActuales) {
        this.setAdministradorDeClima(administradorDeClima);
        this.setClimaActual(climaActual);
