...
public class HabilidadEstadistica2 extends Habilidad2 {
    final private Estadisticas estadistica;
    final private boolean contraRival;

    final private double porcentaje;
    public HabilidadEstadistica2(String nombre, Integer usos, Tipo tipo, String info, Estadisticas estadistica, boolean contraRival) {
    ...
    public Optional<Error> usar() {
        ...
        if (this.pokemonAtacante.puedeUsarHabilidad()) {
            ...
            System.out.println(this.pokemonAtacante + " no puede usar la habilidad por su estado"); //TODO: mejorar este mensaje
        }
